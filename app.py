...
pyt.pytesseract.tesseract_cmd = os.getenv("TESSERACT_CMD", r"C:\Program Files\Tesseract-OCR\tesseract.exe")
...
def get_llama_response(input_text, no_words, blog_style):
    # Get the model path from the environment or default to the local path
    model_path = os.getenv("LANGCHAIN_MODEL_URL", r"D:\mywork\PRACTICE\LLM\llama-2-7b-chat.ggmlv3.q2_K.bin")
